...
Write access to the VFS is blocked. See [ADR-0001](adr/0001-two-tier-runtime.md) for the
design rationale.
...
- [API reference](api.md) — full API surface for all packages
- [Alternatives comparison](alternatives.md) — how browser-containers compares to WebContainers and Nodebox
- [Migration guide](migration.md) — coming from WebContainers or Nodebox
